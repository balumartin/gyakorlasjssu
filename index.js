...
const easy = [
  ...
  const hard = [
   ...
   window.onload = function () {
    ...
    //Add event listener te each number in number container
   ...
   function startGame() {
    ...
    //Creates board based on difficult
    generateBoard(board);
    //Starts the timer
...
function startTimer() {
   ...
   //Sets timer to udupdate every second
   timer = setInterval(function() {
    timeRemaining --;
    //If no time remaining end of the game
...
function generateBoard(board) {
    ...
    for (let i = 0; i < 81; i++) {
        ...
        if (board.charAt(i) != "-") {
            //Set tile text to corrent number
...
function checkCorrect(tile) {
    ...
    //If tile's number is equal t solution's number
